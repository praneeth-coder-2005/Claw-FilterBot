...
API_ID = int(environ['22250562'])
API_HASH = environ['07754d3bdc27193318ae5f6e6c8016af']
BOT_TOKEN = environ['8273811459:AAF1DZqdKwmIrQGus3i7Sljfwx7wNeJeuVY']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1894915577').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1894915577').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Claw_Files")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Claw_Files')
...
DOWNLOAD_TEXT_URL = "https://t.me/Cinemalu_Adda"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Cinemalu_Adda"
